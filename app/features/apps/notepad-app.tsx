...
export function NotepadApp() {
  ...
  return (
    <div className="w-full h-full flex flex-col bg-gray-900 text-blue-400">
      {/* Toolbar */}
      <div className="flex items-center space-x-2 p-2 bg-gray-800 border-b border-blue-400/30">
      ...
      {/* Status Bar */}
      <div className="flex items-center justify-between px-4 py-2 bg-gray-800 border-t border-blue-400/30 text-xs text-blue-400/70">
